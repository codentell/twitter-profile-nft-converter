            ...
            <section style={{ display: "grid", justifyItems: "center", justifyContent: "center" }}>
              <AnimatePresence>
                ...
                >
                  ...
                  <h1 style={{ color: "white", fontSize: "3rem" }}><span style={{
                    background: "linear-gradient(to left, #40b4ff, #96d6ff)", WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent"
                  }}>Twitter</span> PFP → <span style={{
                    background: "linear-gradient(to left, #30D5C8, #1592B4)", WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent"
                  }}>NFT</span> PFP</h1>
                </motion.div>
              </AnimatePresence>
